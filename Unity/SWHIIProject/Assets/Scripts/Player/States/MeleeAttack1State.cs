...
public class MeleeAttack1State : WeaponState
{
    public MeleeAttack1State(PlayerManager player, PlayerStateMachine stateMachine) : base(player, stateMachine) { }
    ...
    public override void HandleInput()
    {
        ...
        {
            stateMachine.ChageState(new MeleeAttack2State(player, stateMachine));
        }
